...
select countrycode, language from countrylanguage where countrycode ilike 'vat';
...
select countrycode, language, percentage from countrylanguage where language ilike 'italian' and percentage = 100;
...
select name, countrycode from city where countrycode ilike 'smr' and name != 'San Marino';
...
select code, name from country where code ilike 'bra';
...
select capital from country where name ilike 'brazil';
